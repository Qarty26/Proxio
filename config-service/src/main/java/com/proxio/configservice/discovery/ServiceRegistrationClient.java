package com.proxio.configservice.discovery;
...
public class ServiceRegistrationClient implements ApplicationRunner {
    ...
    public ServiceRegistrationClient(@Value("${discovery.base-url:http://localhost:8761}") String discoveryBaseUrl,
                                     ...
                                     @Value("${discovery.service-base-url:http://localhost:8888}") String serviceBaseUrl) {
    ...
    public void heartbeat() {
        try {
            ...
            // Config remains available even if discovery is warming up.
        }
    }
